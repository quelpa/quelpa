...
(quelpa-deftest quelpa-expand-recipe-test ()
  ...
  (let ((package-build-rcp '(package-build :repo "melpa/melpa" :fetcher github :files ("package-build.el"))))
    (should
     (equal
...
(quelpa-deftest quelpa-arg-rcp-test ()
  ...
  (let ((quelpa-rcp '(quelpa :repo "quelpa/quelpa" :fetcher github))
        (package-build-rcp '(package-build :repo "melpa/melpa" :fetcher github :files ("package-build.el"))))
    (should
     (equal
